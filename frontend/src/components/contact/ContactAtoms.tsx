// =============================================================================
// FGA CRM - Contact : composants atomiques (extraits de ContactDetail.tsx)
...
export function SideLink({ icon: Icon, label, value, href, internal, trailing }: {
  icon: ElementType; label: string; value?: string | null; href?: string | null; internal?: boolean;
