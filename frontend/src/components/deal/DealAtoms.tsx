// =============================================================================
// FGA CRM - Sous-composants presentationnels de la fiche Deal
// Kpi, Card, Tab, SideLink, Row, EmptyTab.
// Extraits VERBATIM de DealDetail.tsx (refactor C5) — rendu inchange.
// =============================================================================
...
export function SideLink({ icon: Icon, label, value, href, internal }: {
...
export function EmptyTab({ icon: Icon, text }: { icon: React.ElementType; text: string }) {
  return (
